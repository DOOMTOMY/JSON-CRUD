...
loadItens()
  ...
  toggle.addEventListener('change', () => {
    ...
    document.querySelector('#new').classList.toggle('dark-mode');
    document.querySelector('.divTable').classList.toggle('dark-mode');
    document.querySelector('table').classList.toggle('dark-mode');
    document.querySelector('thead').classList.toggle('dark-mode');
